...
export function renderEmailOtp(otp: string, expiryMinutes: number): string {
  ...
  return `<!doctype html>
<html lang="en">
<head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>Your Vanya verification code</title></head>
  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#F3F5EF;">
    <tr><td align="center" style="padding:16px 10px;">
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:440px;">
        <tr><td align="center" style="padding:0 0 12px;font-size:23px;font-weight:700;letter-spacing:-0.8px;color:#214C38;">Vanya<span style="color:#79A35C;">.</span></td></tr>
        <tr><td style="background-color:#FFFFFF;border:1px solid #E0E7DB;border-radius:24px;overflow:hidden;">
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
            ...
            <tr><td style="padding:20px 22px;">
              <p style="margin:0 0 16px;font-size:14px;line-height:21px;color:#66736A;">Enter this code in Vanya to sign in.</p>
        ...
        <tr><td align="center" style="padding:12px 12px 0;font-size:12px;line-height:20px;color:#76816F;">Sent with care by <strong style="color:#49623D;">Vanya</strong></td></tr>
      </table>
    </td></tr>
  </table>
</body>
